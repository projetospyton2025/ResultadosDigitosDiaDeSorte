...
function gerarResumo() {
    ...
    let frequencia = 42;
    let intervaloMedio = 18;
    let menorIntervalo = 1;
    let maiorIntervalo = 56;
    ...
    <ol>
        ...
        <li>
            ...
            <p>Se o intervalo entre as aparições da sequência atingir <strong>15 a 20 concursos</strong>, pode ser um bom indicativo de que ela tem uma boa chance de sair.</p>
        </li>
        <li>
